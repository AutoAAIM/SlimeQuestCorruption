...
export function generarInventario()
{
	...
	scene.magoText = scene.add.text(imagenInventario.x + 71, 210, scene.game.usuario.dinero, {fontSize: '12px', fill: '#FFFFFF', fontFamily: 'sans-serif'}).setDepth(102).setScrollFactor(0);
