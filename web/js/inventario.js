...
export function generarInventario()
{
	...
	dineroText = scene.add.text(sc.config.width / 2 + 73, 210, scene.game.usuario.dinero, {fontSize: '10px', fill: '#FFFFFF', fontFamily: 'sans-serif'}).setDepth(19).setScrollFactor(0);
