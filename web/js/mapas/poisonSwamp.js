...
*/
    create(){
        ...
        this.physics.add.overlap(heroes.cabeza, ranas.ranaGrupo, ranas.activarTrigger);
        this.physics.add.overlap(heroes.cabeza, ranas.ranaGrupo, ranas.updateLenguaRana);
