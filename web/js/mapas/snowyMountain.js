...
export default class montelago extends Phaser.Scene {
	...
	create()
	{
		...
		lago.setTileIndexCallback(freezeTiles, yasha.freeze, scene.physics.add.overlap(lago, yasha.grupoFuego));

		luz.setTileIndexCallback(darkTiles, oscuridad.encenderOscuridad, scene.physics.add.overlap(luz, heroes.heroes));
