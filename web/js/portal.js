...
function changeScene(obj)
{
	if(sceneChanged == false)
	{
		...
		xhr.send("nombre="+myObj.nombre+"&contrasena="+myObj.contrasena+"&dinero="+myObj.dinero+"&zona="+obj.properties.destino+"&inventario1="+objetos[0]+"&inventario2="+objetos[1]+"&inventario3="+objetos[2]+"&inventario4="+objetos[3])
	}
}