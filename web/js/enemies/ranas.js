...
export function preload(){
	this.load.spritesheet('EnemigoRana','assets/images/rana.png', { frameWidth: 32, frameHeight: 32});
...
export function updateLenguaRana(atributo, o){
    ...
    if(o == heroes.cabeza){
        ...
        l.time--;
        scene.physics.add.overlap(heroes.cabeza, l.segmentos, heroes.herir);
    }
...
export function activarTrigger(go, e){
    ...
    if(go.trigger != undefined && go != heroes.cabeza && go != heroes.armasHeroicas){
